...
def upload_panel():
    """Create upload panel component."""
    if not all([HAS_DASH, HAS_DMC, HAS_PANDAS]):
        raise ImportError("Required components not available. Install with: pip install dash dash-mantine-components pandas")
                        ...
                        children=[
                            dmc.Stack(
                                [
                                    ...
                                    dmc.Title("Preview", order=3, c="blue"),
                            ...
                            dmc.Stack(
                                [
                                    dmc.Textarea(
                                        ...
                                        placeholder="Write here",
                                        autosize=True,
                                        leftSection=DashIconify(icon="material-symbols:search"),
                                        maxRows=2,
                                    ),
                                    dmc.LoadingOverlay(
                                        id="output-card",
            ...
            dmc.Group(
                [
                    dmc.Button(
                        ...
                        variant="outline",
                        radius="xl",
                        leftSection=DashIconify(icon="ic:round-arrow-back"),
                    ),
                    dmc.Button(
                        "Next",
                        id="stepper-next",
