...
def dataset_description(dataset_name: str):
    """Create dataset description component."""
...
def graph_with_loading():
    """Create graph component with loading spinner."""
...
def interpretation_of_plot():
    """Create plot interpretation component."""
    component = html.Div([
...
def visualization_panel():
    ...
    for name, desc in d.items():
        ...
        # Use iframe as a safe replacement for dash_dangerously_set_inner_html
        button_icon = html.Iframe(
            srcDoc=svg_html,
